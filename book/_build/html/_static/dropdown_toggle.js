...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateToggleButton() {
        ...
        if (allOpen) {
            ...
            button.title = "Cerrar todos los desplegables";
        } else if (allClosed) {
            button.innerHTML = '<i class="fa-solid fa-angles-down"></i>';
            button.title = "Abrir todos los desplegables";
        }
            ...
            button.innerHTML = `
                <div class="dropdown" style="margin-right:-2px">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" class="btn btn-sm dropdown-item" data-action="open" title="Abrir todos los desplegables">
                            <span class="btn__icon-container">
                                <i class="fa-solid fa-angles-down"></i>
                            </span>
                            <span class="btn__text-container">Abrir todos los desplegables</span>
                        </a></li>
                        <li><a href="#" class="btn btn-sm dropdown-item" data-action="close" title="Cerrar todos los desplegables">
                            <span class="btn__icon-container">
                                <i class="fa-solid fa-angles-up"></i>
                            </span>
                            <span class="btn__text-container">Cerrar todos los desplegables</span>
                        </a></li>
                    </ul>
                    </div>`;
            button.title = "Algunos desplegables abiertos, algunos cerrados";
        }
